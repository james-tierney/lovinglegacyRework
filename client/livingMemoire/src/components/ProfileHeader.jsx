...
const ProfileHeader = ({username, email, dateCreated, profilePicture}) => {
  ...
  return (
    <div style={{ backgroundColor: "white", padding: "2rem", color: 'black',borderRadius: '8px', border: '2px solid #ccc' }}>
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        ...
        <div style={{ maxWidth: "20rem", padding: "1rem", backgroundColor: "#F0E8D1", borderRadius: "0.25rem", border: "1px solid #D4A42F" }}>
