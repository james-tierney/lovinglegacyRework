        ...
        <div className="container">
            <nav className="border-b mb-4">
                <ul className="flex space-x-6 p-4"> {/* Added list-none class */}
                    <li><a href="#" className="text-blue-600 hover:text-blue-800">My favorites</a></li>
                    <li><a href="#" className="text-blue-600 hover:text-blue-800">Posts</a></li>
                    <li><a href="#" className="text-blue-600 hover:text-blue-800">Medallions</a></li>
                    <li><a href="#" className="text-blue-600 hover:text-blue-800">My account</a></li>
                </ul>
